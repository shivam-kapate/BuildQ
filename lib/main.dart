...
// --- 3. HOME PAGE (Now with Bottom Navigation) ---
...
class _HomePageState extends State<HomePage> {
  int _selectedIndex = 0; // Tracking the current tab
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      _buildHomeContent(), // Tab 0
      const BookingsScreen(), // Tab 1
      const WorkerDashboard(), // Tab 2
    ];

    return Scaffold(
      backgroundColor: const Color(0xFFF8F9FB),
      // Only show the Location AppBar if we are on the Home Tab
      appBar: _selectedIndex == 0 ? _buildLocationAppBar() : null,
  ...
  PreferredSizeWidget _buildLocationAppBar() {
    return AppBar(
      elevation: 0,
      backgroundColor: Colors.white,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Quality Skills, Quick Connections",
